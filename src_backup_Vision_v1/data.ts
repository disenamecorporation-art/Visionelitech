...
export const PRODUCTS_DATA: ProductDetails[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Overclocking de fábrica certificado para estabilidad máxima de 24 horas."
    ],
    specs: [
  ...
  {
    id: "mouse-viper-v3",
    name: "RATÓN GAMER RAZER VIPER V3 PRO",
    tagline: "El ratón inalámbrico ultraligero preferido por profesionales de eSports.",
    category: "perifericos",
    priceUSD: 160,
    priceVES: 160 * EXCHANGE_RATE_VES,
    stock: "DISPONIBLE",
...
export const CAROUSEL_SLIDES: (imageUrls: { slide1: string; slide2: string; slide3: string }) => CarouselSlide[] = (
  imageUrls
) => [
  {
    id: 1,
    ...
    image: "https://i.postimg.cc/85xPn1f5/banner1.jpg", // First slide image requested by user!
    themeColor: "cyan",
  ...
  {
    id: 2,
    title: "MÁXIMO CONFORT Y SONIDO",
    subtitle: "COMODIDAD DE ÉLITE",
    buttonText: "EXPLORAR EQUIPO",
    image: "https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&q=80&w=1290&h=500", // High-res gaming keyboard and desktop setup
    themeColor: "yellow",
  ...
  {
    id: 3,
    title: "RENDIMIENTO SUPREMO",
    subtitle: "GPU LIQUIDA Y ARQUITECTURA DIGITAL",
    buttonText: "VER COMPONENTES",
    image: "https://images.unsplash.com/photo-1603481588273-2f908a9a7a1b?auto=format&fit=crop&q=80&w=1290&h=500", // Premium gaming components on workstation
    themeColor: "emerald",
    accentClass: "border-emerald-500/30 hover:border-emerald-400/60 shadow-[0_0_20px_rgba(16,185,129,0.15)]",
    textGlowClass: "text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-500 to-cyan-500 drop-shadow-[0_0_15px_rgba(20,184,166,0.4)]",
    detailsId: "ultimate-performance-pc"
  }
];
