    ...
    >
      ...
      >
        ...
        <div className="flex-1 space-y-4 text-center lg:text-left relative z-10">
          <h3 className="font-sans font-light text-2xl sm:text-3xl md:text-4xl text-white tracking-wide uppercase">
          ...
          <p className="font-sans text-xs text-white/50 max-w-xl leading-relaxed">
            Elige cada componente y chasis ARGB para tu máquina ideal, o explora nuestro catálogo con entrega física inmediata en Caracas.
          </p>
        </div>
